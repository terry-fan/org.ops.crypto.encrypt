...
/* entry point */
mainClass in (Compile, packageBin) := Some("org.ops.crypto.encrypt.Encrypt")

mainClass in (Compile, run) := Some("org.ops.crypto.encrypt.Encrypt")
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("org.ops.crypto.encrypt.Encrypt")
